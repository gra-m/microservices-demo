...
/**
 * wrapper class around KafkaProducer brings together configurations from KafkaConfigData and KafkaProducerConfigData
 * so that producer is set up to spec at runtime.
 *
...
/**
 * A bean used to get the config details into the map format required by KafkaTemplate to set up producer in Spring
