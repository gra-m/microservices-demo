...
/**
 * Cannot use @RestController here as it auto converts to json, instead @Controller. This is the
 * gateway api into the web application
 */
@Controller
public class QueryController {
  ...
  public String home(Model model) {
    model.addAttribute(
        "elasticQueryWebClientRequestModel", ElasticQueryWebClientRequestModel.builder().build());
    return "home";
  }
