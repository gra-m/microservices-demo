 ...
 *
 * <p>Allows access to RestApi endpoints if user My First Take (MFT== not researched == all prior
 * comments!) --> Difference with config-server SecurityConfig.class is @EnableWebSecurity as
 * opposed to enabling internal library endpoints for encrypt/decrypt
 */
